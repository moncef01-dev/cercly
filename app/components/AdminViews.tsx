      ...
      <>
        ...
        <div className="hero-card">
          ...
          <div className="hero-sub">
            اجمع لأثر يدوم • الأثر البيئي الإجمالي متزايد
          </div>
        </div>
        ...
        {pendingOrdersCount > 0 && (
          <div className="alert warning">
            ...
            <span>
              يوجد {pendingOrdersCount} طلب شراء معلق بانتظار الموافقة
            </span>
          </div>
        )}
        ...
        >
          <button
            ...
            onClick={() => {}}
            style={{ width: "100%", pointerEvents: "none", opacity: 0.9 }}
          >
        ...
        <div className="card">
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            {[
              ...
              {
                r: "طلبات شراء معلقة",
                n: pendingOrdersCount,
                s: pendingOrdersCount > 0 ? "معلق" : "نشط",
              },
              {
                r: "شحنات اليوم",
                n: shipments.length,
                s: shipments.length > 0 ? "جارٍ" : "نشط",
              },
            ].map((o, i) => (
              <div className="order-row" key={i}>
                ...
                <div className="order-info">
                  <div className="order-title">{o.r}</div>
                </div>
                <div
                  style={{
                    fontSize: "15px",
                ...
                <span
                  className={`badge ${o.s === "نشط" ? "badge-green" : o.s === "معلق" ? "badge-orange" : "badge-blue"}`}
                >
                  {o.s}
                </span>
              </div>
      ...
      <>
        ...
        <div className="tabs">
          {[
            ...
            <button
              key={t.id}
              className={`tab${userFilter === t.id ? " active" : ""}`}
          ...
          {filteredUsers.map((u) => (
            <div className="card" style={{ padding: "14px" }} key={u.id}>
              <div className="flex-between">
                ...
                >
                  <span
                    className={`badge ${u.status === "active" ? "badge-green" : "badge-orange"}`}
                  >
              ...
              <div className="order-row" key={o.id}>
                ...
                <div className="order-info">
                  ...
                  <div className="order-sub">
                    {o.factoryName} ← {o.centerName} •{" "}
                    {o.quantity.toLocaleString()} كجم
                  </div>
                </div>
                <button
                  className="btn-primary"
        ...
        <div className="card">
          <div className="card-header">
            <span className="card-title">
              المكافآت المتاحة بالمنصة ({rewards.length})
            </span>
          </div>
          <div
            style={{
          ...
          >
            {rewards.map((r) => (
              <div
                className="kpi-card"
                style={{ padding: "12px 6px", minHeight: "90px", gap: "4px" }}
                key={r.id}
              >
